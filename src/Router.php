...
class Router
{
    ...
    public static function setRoute(string $uri, $controller, string $method): void
    {
    ...
    public static function any(string $uri, $controller): void
    {
    ...
    public static function match(string $uri, string $method): bool
    {
        $routeFound = [];
        $routeParams = [];
